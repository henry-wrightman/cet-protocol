...
interface NearestWagerModuleInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "decodeNearestWager",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
...
export class NearestWagerModule extends BaseContract {
  ...
  interface: NearestWagerModuleInterface;

  functions: {
    decodeNearestWager(
      data: BytesLike,
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { wagerPrice: BigNumber }>;
