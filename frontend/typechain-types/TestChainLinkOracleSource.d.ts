...
interface TestChainLinkOracleSourceInterface extends ethers.utils.Interface {
  functions: {
...
export class TestChainLinkOracleSource extends BaseContract {
  ...
  interface: TestChainLinkOracleSourceInterface;
