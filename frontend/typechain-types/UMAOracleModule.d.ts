...
interface UMAOracleModuleInterface extends ethers.utils.Interface {
  functions: {
    ...
    "requestData((bytes,bytes,bytes,uint256,bytes,bytes,bytes,bytes,uint8,address,address,address))": FunctionFragment;
    "settleRequest((bytes,bytes,bytes,uint256,bytes,bytes,bytes,bytes,uint8,address,address,address))": FunctionFragment;
